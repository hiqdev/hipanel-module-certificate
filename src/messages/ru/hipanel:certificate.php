...
return [
    ...
    'Domain Control Validation method' => 'Способ валидации домена',
    'Email' => 'Email',
    'Expires' => 'Истекает',
    ...
    'In order to confirm domain ownership by this method, you will need to create a working DNS record in your domain' => 'Для подтверждения владения этим доменом, Вам необходимо будет создать рабочую DNS запись в вашем домене',
    'In order to confirm domain ownership by this method, you will need to create a file on site' => 'Для подтверждения владения этим доменом, Вам необходимо будет создать файл на сайте',
    'Make sure you can do this before choosing this method' => 'Убедитесь, что Вы можете это сделать, прежде чем выбирать этот способ',
    ...
    'Alternate domain validations' => 'Альтернативные способы валидации',
    ...
    'Change validation' => 'Изменить способ валидации',
    'Confirm certificate validation method changing' => 'Подтвердите изменение способа валидации',
    'Certificate validation method was changed' => 'Способ валидации был изменен',
    'Error changing validation method' => 'Возникла ошибка при смене способа валидации',
    'Resend validation' => 'Отправить данные валидации',
    'Validation data was sended' => 'Данные для валидации были отправлены',
    'Error during sending notifications' => 'Возникли ошибки при повторной отправке данных валидации',
